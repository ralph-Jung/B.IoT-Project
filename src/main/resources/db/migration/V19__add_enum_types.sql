...
ALTER TABLE room_device ALTER COLUMN status DROP DEFAULT;
ALTER TABLE room_device ALTER COLUMN mode   DROP DEFAULT;
...
ALTER TABLE room_device ALTER COLUMN status SET DEFAULT 'OFF'::device_status;
ALTER TABLE room_device ALTER COLUMN mode   SET DEFAULT 'AUTO'::control_mode;
